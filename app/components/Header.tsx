        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20 lg:h-[101px]">
            ...
            <nav className="hidden lg:flex space-x-8 text-sm uppercase tracking-wider">
              ...
              <Link href="/planners" className="hover:text-[#56cfe1] transition-colors">Planners</Link>
            ...
            <div className="flex items-center space-x-6">
              <button className="hover:text-[#56cfe1] transition-colors">
              ...
              <button className="hover:text-[#56cfe1] transition-colors relative">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
                <span className="absolute -top-2 -right-2 bg-[#56cfe1] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">0</span>
              </button>
            </div>
          </div>
        </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 bg-white">
            <nav className="flex flex-col p-4 space-y-4">
              ...
              <Link href="/planners" className="text-sm uppercase tracking-wider hover:text-[#56cfe1]">Planners</Link>
